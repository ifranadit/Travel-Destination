...
/* Mengecek apakah tombol simpan sudah di pilih/klik atau belum */
	...
	if($namafoto == ""){
        mysqli_query($conn, "UPDATE berita SET berita_JUDUL = '$berita_JUDUL', berita_ISI = '$berita_ISI', berita_SUMBER = '$berita_SUMBER', kategori_ID = '$kategoriKODE' WHERE berita_ID = '$berita_ID'");
    }else{
            mysqli_query($conn, "UPDATE berita SET berita_JUDUL = '$berita_JUDUL', berita_ISI = '$berita_ISI', berita_SUMBER = '$berita_SUMBER', kategori_ID = '$kategoriKODE', berita_FOTO = '$namafoto' WHERE berita_ID = '$berita_ID'");
    }
